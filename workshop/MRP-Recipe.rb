$appbuildstore = https://github.com/dtzar/chef/blob/master/workshop/mrpapp-build
...
remote_file 'mongodb_data' do
    source 'https://github.com/dtzar/chef/blob/master/workshop/mrpapp-build/MongoRecords.js'
...
remote_file 'mrp_app' do
    source 'https://github.com/dtzar/chef/blob/master/workshop/mrpapp-build/mrp.war'
...
remote_file 'ordering_service' do
    source 'https://github.com/dtzar/chef/blob/master/workshop/mrpapp-build/ordering-service-0.1.0.jar'
